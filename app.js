const commonQuestions = [
  ...
  "이 책을 색깔로 표현한다면 어떤 색인지",
  "책을 다 읽고 가장 먼저 든 생각은?",
  "이 책을 누구에게 추천하고 싶은지",
  "제목을 새로 붙인다면 어떻게 바꾸고 싶은지",
  "읽는 동안 가장 잘 어울렸던 음악이나 소리는?",
  "이 책을 한 단어로 표현한다면?",
];
...
const genreQuestions = {
  fiction: {
    ...
    questions: [
      ...
      "가장 기억에 남는 대사나 문장은?",
      "가장 정이 갔던 인물은 누구인지",
      "이야기 속 장소 중 가보고 싶은 곳은?",
      "중간에 가장 궁금했던 장면은?",
      "내가 바꾸고 싶은 장면이 하나 있다면?",
      "이 소설의 분위기를 날씨로 표현한다면?",
    ],
  },
  nonfiction: {
    label: "비문학",
    ...
    questions: [
      ...
      "이 책 읽고 누군가 떠올랐는지",
      "새롭게 알게 된 사실 하나는?",
      "이 책에서 가장 쉽게 따라할 수 있는 부분은?",
      "읽기 전 생각과 달라진 점이 있는지",
      "주변 사람에게 알려주고 싶은 내용은?",
      "가장 고개를 끄덕였던 부분은?",
      "이 책을 읽고 검색해보고 싶어진 것이 있는지",
    ],
  },
  essay: {
    label: "에세이",
